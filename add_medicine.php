...
body {
	...
	<?php
      ...
      ?>
		...
		<div style="text-align:center;"> <img src="image\med.jpg" width="150" height="100">  </div>
		...
		<div class="container">
			<form action="add_medicine_action.php" method = "get">
				...
				<div class="row">
					<div class="col-25">
						<label for="lname">Cost(per each)</label>
					</div>
					<div class="col-75">
			...
			<h2 style="font-style:italic; font-size:30px;padding-left:30px;"><a href=medicinals.php>Go Back</a></h2>
		</div>
