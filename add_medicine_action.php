...
<?php
		...
		$sql = "INSERT INTO medicine_database (user_id,medicine_name, quantity, expiry_date, amount) 
		VALUES ('$userid','$medname', '$qty','$exdate','$amt')";


		if ($conn->query($sql) === TRUE) {
		//echo "New record created successfully";
		echo "<div id='card'><p>Medicine Successfully Added</p><form action='medicinals.php' method='get'><button type='submit' id='done'>Done</button></form></div>";
