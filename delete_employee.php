...
body {
	...
	<?php
      ...
      ?>
		...
		<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Delete Employee</h2>
		
		<div style="text-align:center;"> <img src="image\deletemain.png">  </div>
		
		<div class="container">
			<form action="delete_employee_action.php" method = "get">
				...
				<div class="row">
					...
					<div class="col-75">
						<input type="text" pattern=".{1,}" required name="emp_id" placeholder="Enter employee Id...">
					</div>
				</div>
