...
body {
	...
	<ul>
			...
			<h2 style="font-style:italic; font-size:30px;padding-left:30px;">Expired Medicines</h2>
	...
	<?php
		...
		$ret=mysqli_query($conn,$sql);
            ...
            if(mysqli_num_rows($ret)==0)
            {
                      echo "<div id='card'><h1>No Medicine is expired....</h1><form action='medicinals.php'><button type='submit' id='done'>Done</button></form></div>";
